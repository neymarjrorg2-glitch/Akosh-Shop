...
MIGRATIONS = [
    ...
    "ALTER TABLE bot_products ADD COLUMN IF NOT EXISTS hosting_price FLOAT DEFAULT 0",
    ...
    "ALTER TABLE orders ADD COLUMN IF NOT EXISTS api_key VARCHAR(256)",
    "ALTER TABLE orders ADD COLUMN IF NOT EXISTS admin_telegram_id VARCHAR(32)",
    "ALTER TABLE orders ADD COLUMN IF NOT EXISTS hosting_price FLOAT DEFAULT 0",
    "ALTER TABLE orders ADD COLUMN IF NOT EXISTS hosting_next_due TIMESTAMP",
    "ALTER TABLE orders ADD COLUMN IF NOT EXISTS hosting_active BOOLEAN DEFAULT TRUE",
    "ALTER TABLE orders ADD COLUMN IF NOT EXISTS hosting_reminder_sent BOOLEAN DEFAULT FALSE",
